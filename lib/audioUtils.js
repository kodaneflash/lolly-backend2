...
const rhubarbPath = "/usr/local/bin/rhubarb"; // Path to rhubarb inside Docker
const resPath = "/usr/local/bin/res"; // ✅ Correct resource path for Rhubarb
...
export const lipSyncMessage = async (uniqueId) => {
  ...
  await new Promise((resolve, reject) => {
    const rhubarb = spawn(rhubarbPath, [
      ...
      env: {
        ...process.env,
        POCKETSPHINX_PATH: resPath, // ✅ Corrected to match Docker location
      },
    });
