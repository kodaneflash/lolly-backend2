...
const ffmpegPath = "/usr/bin/ffmpeg"; // Path to ffmpeg inside Docker
...
const rhubarbPath = path.resolve(__dirname, "../bin", isWindows ? "rhubarb.exe" : "rhubarb");
...
export const generateSpeechWithStreaming = async (text, outputFilePath) => {
  console.log("📞 Calling ElevenLabs TTS..."); // Added log
  try {
...
export const lipSyncMessage = async (uniqueId) => {
  console.log("👄 Starting lip sync process..."); // Added log
  ...
  console.log("✅ Lip sync process completed."); // Added log
};
