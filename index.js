...
app.post("/chat", async (req, res) => {
  ...
  - text: a short text response , professional and friendly , you know all about the website www.neemba.com and you provide information about the services and the company.
